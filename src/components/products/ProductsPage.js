...
function ProductsPage({handleAddComp,handleCarts,searchProduct}) {
  ...
  const [brandCheckKey, setBrandKey] = useState([
    {id:1, name:"Venus Handicrafts", checked: false},
    {id:2, name:"Chuny", checked: false},
    {id:3, name:"YDBJ", checked: false},
    {id:4, name:"Jaipur", checked: false},
    {id:5, name:"YSHP", checked: false},
    {id:6, name:"Hario", checked: false},
    {id:7, name:"Joyboy", checked: false},
    {id:8, name:"Glass Art Stories", checked: false},
    {id:9, name:"Other Brands", checked: false}



  ]);
  const [ categoriesCheckkey, setCategoriesCheckkey] =useState([
    {id:1, name:"Iron Handicrafts", checked: false},
    {id:2, name:"Glass Handicrafts", checked: false},
    {id:3, name:"Aluminium Handicrafts", checked: false},
    {id:4, name:"Wood Handicrafts", checked: false},
    {id:5, name:"Home Decor", checked: false},
    {id:6, name:"Candle Accessories", checked: false},
    {id:7, name:"Table wares", checked: false},
    {id:8, name:"Guest Chairs", checked: false},
    {id:9, name:"Handicrafts Decorative", checked: false},
    {id:10, name:"Others", checked: false}
  ])
    ...
    <div className='productspage'>
      <div className='productspage-banner'>
        ...
        <div className='productspage-banner-title'>
          <h1>PRODUCTS</h1>
          <h3>KEEP EVERYTHING NATURAL</h3>
          <h5>Handicrafts are not only beautiful products, but also an expression of culture and tradition. They can be used to preserve and transmit the stories and values of a community.</h5>
        </div>
      </div>
